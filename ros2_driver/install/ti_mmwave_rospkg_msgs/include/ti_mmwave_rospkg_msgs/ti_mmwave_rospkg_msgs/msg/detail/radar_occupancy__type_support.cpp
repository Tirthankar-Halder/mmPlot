...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RadarOccupancy_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(ti_mmwave_rospkg_msgs::msg::RadarOccupancy, header),  // bytes offset in struct
