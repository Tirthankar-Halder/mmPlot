...
static rosidl_typesupport_introspection_c__MessageMember ti_mmwave_rospkg_msgs__msg__RadarOccupancy__rosidl_typesupport_introspection_c__RadarOccupancy_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(ti_mmwave_rospkg_msgs__msg__RadarOccupancy, header),  // bytes offset in struct
    NULL,  // default value
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ti_mmwave_rospkg_msgs, msg, RadarOccupancy)() {
  ti_mmwave_rospkg_msgs__msg__RadarOccupancy__rosidl_typesupport_introspection_c__RadarOccupancy_message_member_array[0].members_ =
