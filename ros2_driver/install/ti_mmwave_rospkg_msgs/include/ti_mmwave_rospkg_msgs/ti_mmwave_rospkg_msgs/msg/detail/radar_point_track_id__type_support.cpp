...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RadarPointTrackID_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(ti_mmwave_rospkg_msgs::msg::RadarPointTrackID, header),  // bytes offset in struct
