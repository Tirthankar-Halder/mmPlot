...
static rosidl_typesupport_introspection_c__MessageMember ti_mmwave_rospkg_msgs__msg__RadarScan__rosidl_typesupport_introspection_c__RadarScan_message_member_array[10] = {
  {
    "header",  // name
    ...
    offsetof(ti_mmwave_rospkg_msgs__msg__RadarScan, header),  // bytes offset in struct
    NULL,  // default value
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ti_mmwave_rospkg_msgs, msg, RadarScan)() {
  ti_mmwave_rospkg_msgs__msg__RadarScan__rosidl_typesupport_introspection_c__RadarScan_message_member_array[0].members_ =
