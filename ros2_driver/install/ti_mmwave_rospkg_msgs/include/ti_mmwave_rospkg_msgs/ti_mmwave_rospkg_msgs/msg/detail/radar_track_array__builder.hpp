...
class Init_RadarTrackArray_header
{
public:
  Init_RadarTrackArray_header()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_RadarTrackArray_num_tracks header(::ti_mmwave_rospkg_msgs::msg::RadarTrackArray::_header_type arg)
  {
...
{
  return ti_mmwave_rospkg_msgs::msg::builder::Init_RadarTrackArray_header();
}
