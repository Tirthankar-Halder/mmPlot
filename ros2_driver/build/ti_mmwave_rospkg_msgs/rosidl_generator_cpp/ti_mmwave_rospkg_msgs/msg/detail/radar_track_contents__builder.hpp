...
class Init_RadarTrackContents_header
{
public:
  Init_RadarTrackContents_header()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_RadarTrackContents_tid header(::ti_mmwave_rospkg_msgs::msg::RadarTrackContents::_header_type arg)
  {
...
{
  return ti_mmwave_rospkg_msgs::msg::builder::Init_RadarTrackContents_header();
}
