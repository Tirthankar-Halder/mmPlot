...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RadarTrackArray_message_member_array[3] = {
  {
    "header",  // name
    ...
    offsetof(ti_mmwave_rospkg_msgs::msg::RadarTrackArray, header),  // bytes offset in struct
