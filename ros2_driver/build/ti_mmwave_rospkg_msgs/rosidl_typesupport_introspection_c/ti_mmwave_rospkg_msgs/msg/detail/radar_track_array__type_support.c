...
static rosidl_typesupport_introspection_c__MessageMember ti_mmwave_rospkg_msgs__msg__RadarTrackArray__rosidl_typesupport_introspection_c__RadarTrackArray_message_member_array[3] = {
  {
    "header",  // name
    ...
    offsetof(ti_mmwave_rospkg_msgs__msg__RadarTrackArray, header),  // bytes offset in struct
    NULL,  // default value
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ti_mmwave_rospkg_msgs, msg, RadarTrackArray)() {
  ti_mmwave_rospkg_msgs__msg__RadarTrackArray__rosidl_typesupport_introspection_c__RadarTrackArray_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  ti_mmwave_rospkg_msgs__msg__RadarTrackArray__rosidl_typesupport_introspection_c__RadarTrackArray_message_member_array[2].members_ =
